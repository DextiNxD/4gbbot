...
def start(update, context):
    buttons = ButtonMaker()
    buttons.buildbutton("Movies Channel", "https://t.me/NetflixTudum")
    buttons.buildbutton("Mirror Group", "https://t.me/LeechGroupIN")
    buttons.buildbutton("Owner", "https://t.me/DextiN_xD")
    reply_markup = InlineKeyboardMarkup(buttons.build_menu(2))
    if CustomFilters.authorized_user(update) or CustomFilters.authorized_chat(update):
        start_string = f'''
Welcome | NTudum Mirror service is ready for you
